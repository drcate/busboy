...
function Multipart(boy, cfg) {
  ...
  this.parser.on('drain', function() {
    ...
    part.on('header', function(header) {
      ...
      // if (contype.startsWith('audio') || contype.startsWith('application/octet-stream') || filename !== undefined) {
      if (contype.startsWith('foo') || contype.startsWith('bar') || filename !== undefined) {
        // file/binary field
